...
func (app *application) routes() http.Handler {
	...
	router.Handle("POST /v1/subjects/{year}", write.ThenFunc(app.createSubjectHandler))
	...
	router.Handle("POST /v1/students/{year}", write.ThenFunc(app.createStudent))
	...
	router.Handle("POST /v1/carryovers/{year}", write.ThenFunc(app.createCarryover))
	...
	router.Handle("POST /v1/exempteds/{year}", write.ThenFunc(app.createExempted))
	...
	router.Handle("POST /v1/marks/{year}", write.ThenFunc(app.createMark))
