...
func (app *application) failedValidationResponse(w http.ResponseWriter, r *http.Request, errors map[string]string) {
	w.Header().Set("Access-Control-Allow-Origin", "http://localhost:5173")                   // Allow the Vue.js app to make requests
	w.Header().Set("Access-Control-Allow-Methods", "GET, POST, PUT, PATCH, DELETE, OPTIONS") // Allow these HTTP methods
